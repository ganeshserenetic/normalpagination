...
class pagination {
	...
	protected function build_links() {
		...
		$this->links_html .= '	<div class="float-start">'. PHP_EOL;
		$this->links_html .= '		<div class="dataTables_info mt-2">Showing '.$start.' to '.$end.' of '.$this->total_results.' Records</div>'. PHP_EOL;
		$this->links_html .= '	</div>'. PHP_EOL;
		$this->links_html .= '	<div class="float-end">'. PHP_EOL;
		$this->links_html .= '		<div class="dataTables_paginate paging_bs_normal">'. PHP_EOL;
	...
	protected function build_links_first_prev() {
		...
		if ($this->options['show_links_first_last'] == true) {
			if ($this->current_page == 1 && $this->options['show_links_first_last_if_dead'] == true) {
				$this->links_html .= '<li class="page-item prev ' . $this->options['class_dead_links'] . '"><span class="page-link">' . $this->options['text_first'] . '</span></li>' . PHP_EOL;
			} elseif ($this->current_page != 1) {
				$this->links_html .= '<li class="page-item ' . $this->options['class_live_links'] . '"><a class="page-link" href="' . $this->build_link_url(1) . '">' . $this->options['text_first'] . '</a></li>' . PHP_EOL;
			}
		...
		if ($this->options['show_links_prev_next'] == true) {
			if ($this->current_page == 1 && $this->options['show_links_prev_next_if_dead'] == true) {
				$this->links_html .= '<li class="page-item d-none prev ' . $this->options['class_dead_links'] . '"><span class="page-link">' . $this->options['text_prev'] . '</span></li>' . PHP_EOL;
			} elseif ($this->current_page != 1) {
				$this->links_html .= '<li class="page-item ' . $this->options['class_live_links'] . '"><a class="page-link" href="' . $this->build_link_url($this->current_page - 1) . '">' . $this->options['text_prev'] . '</a></li>' . PHP_EOL;
			}
	...
	protected function loop_through_links($start, $finish, $array_block_label = '') {
		...
		while ($counter <= $finish) {
			if ($this->options['current_page_is_link'] == false && $counter == $this->current_page) {
				...
				$this->links_html .= '<li class="page-item  ' . $this->get_current_or_normal_class($counter) . '"><a class="page-link" href="' . $this->build_link_url($counter) . '">' . $counter . '</a></li>' . PHP_EOL;
			}
	...
	protected function add_ellipses() {
		$this->links_html .= '<li class="page-item "><span class="page-link' . $this->options['class_ellipses'] . '">' . $this->options['text_ellipses'] . '</span></li>' . PHP_EOL;
	}
	...
	protected function build_links_next_last() {
		...
		if ($this->options['show_links_prev_next'] == true) {
			if ($this->current_page == $this->total_pages && $this->options['show_links_prev_next_if_dead'] == true) {
				$this->links_html .= '<li class="page-item d-none ' . $this->options['class_dead_links'] . '"><span class="page-link">' . $this->options['text_next'] . '</span></li>' . PHP_EOL;
			} elseif ($this->current_page != $this->total_pages) {
				$this->links_html .= '<li class="page-item d-none ' . $this->options['class_live_links'] . '"><a class="page-link" href="' . $this->build_link_url($this->current_page + 1) . '">' . $this->options['text_next'] . '</a></li>' . PHP_EOL;
			}
		...
		if ($this->options['show_links_first_last'] == true) {
			if ($this->current_page == $this->total_pages && $this->options['show_links_first_last_if_dead'] == true) {
				$this->links_html .= '<li class="page-item ' . $this->options['class_dead_links'] . '"><span class="page-link">' . $this->options['text_last'] . '</span></li>' . PHP_EOL;
			} elseif ($this->current_page != $this->total_pages) {
				$this->links_html .= '<li class="page-item ' . $this->options['class_live_links'] . '"><a class="page-link" href="' . $this->build_link_url($this->total_pages) . '">' . $this->options['text_last'] . '</a></li>' . PHP_EOL;
			}
